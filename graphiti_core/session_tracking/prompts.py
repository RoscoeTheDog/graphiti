...
DEFAULT_USER_MESSAGES_TEMPLATE = """Summarize this user message in 1 paragraph or less.
...
DEFAULT_AGENT_MESSAGES_TEMPLATE = """Summarize this agent response in 1 paragraph or less.
