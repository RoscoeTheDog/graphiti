...
| Implementation | 13.1.i | completed | Code changes |
...
- [x] Add `session_tracking_sync_history` tool to `mcp_server/graphiti_mcp_server.py`
- [x] Tool parameters: `project`, `days`, `max_sessions`, `dry_run`
- [x] Tool returns JSON response matching existing function signature
- [x] Tool validates session_manager is initialized before calling
- [x] Add unit test for MCP tool wrapper
