...
- [x] (P0) Management API endpoints implemented: `/api/v1/status`, `/api/v1/session/sync`, `/api/v1/session/history`, `/api/v1/config`, `/api/v1/config/reload`
- [x] (P0) `GraphitiClient` HTTP client class created with methods for all API operations
- [x] (P1) Daemon config schema added to `unified_config.py` with Pydantic validation
- [x] (P1) Auto-discovery logic implemented (env var → config file → default URL)
- [x] (P2) Client includes proper timeout handling and connection error detection
