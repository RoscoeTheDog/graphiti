...
- [ ] **(P1) AC-18.3.1**: add_memory() accepts wait_for_completion parameter
- [ ] **(P1) AC-18.3.2**: wait_for_completion=true blocks until processing completes
- [ ] **(P1) AC-18.3.3**: wait_for_completion=false returns immediately (current behavior)
- [ ] **(P1) AC-18.3.4**: Default value comes from config (wait_for_completion_default)
- [ ] **(P1) AC-18.3.5**: Timeout handling prevents indefinite blocking
- [ ] **(P1) AC-18.3.6**: All tests pass
