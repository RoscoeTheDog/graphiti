...
- [ ] **(P1) AC-18.2.1**: ErrorCategory includes LLM_NETWORK value
- [ ] **(P1) AC-18.2.2**: ErrorCategory includes LLM_QUOTA_EXCEEDED value
- [ ] **(P1) AC-18.2.3**: create_network_error() factory function exists
- [ ] **(P1) AC-18.2.4**: create_quota_error() factory function exists with provider URL support
- [ ] **(P1) AC-18.2.5**: All new tests pass
